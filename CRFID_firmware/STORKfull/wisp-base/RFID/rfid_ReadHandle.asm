...
; TODO: remove all innecesary and outdated comments, because this timing information is not crucial anymore, since c1g2 version 2.0  *
;																																	 *
;************************************************************************************************************************************/
...
;************************************************************************************************************************************/
	...
	CALLA	#crc16_ccitt		;[5+20+7*nr_of_bytes]=< [137]
...
waitOnBits_2a:
	...
	CMP.B		#(0), &(RWData.rdHook)       ;[4]
	JEQ			waitOnBits_3			      ;[2]
	MOV			&(RWData.rdHook), R_scratch0 ;[3]
	CALLA		R_scratch0			         ;[5+x]
