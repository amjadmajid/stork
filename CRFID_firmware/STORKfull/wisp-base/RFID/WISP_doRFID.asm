...
;loopEndLessInCRCfunction:
	...
	CALLA	#crc16_ccitt			;([5+(18+14*nr_of_bytes)]= [23+14*14] = [219] = oldSoftwareCRC)
									;([5+(20+7*nr_of_bytes)]= [25+ 7*14] = [123]  = hardWareCRC)
	;onReturn: R12 holds the CRC16 value.
	;JMP		loopEndLessInCRCfunction [2]
	;STORE CRC16
...
decodeCmd_lvl1:
	...
	;JNZ		endDoRFID			; If eavesdropping, ignore everything but blockwrite
