...
; -Solution: Reader uses an inventory filter for the last 16bits of the EPC value (i.e. dataBuf[2] | dataBuf[3]) when it wants to
...
handleSelect:
	...
	CMP.B	#0x0002,	R_scratch0	;[] check if correct bitPtr (this is equivalent to BitPtr=0x0002 but jumbled around)
	...
	;	-e.g. (dataBuf+2) loads R_scratch0 = (cmd[3] | cmd[2])
