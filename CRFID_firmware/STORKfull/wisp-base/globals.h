...
#define TX_TIMING_READ  (0)//58.0us
...
typedef struct {
    ...
    uint8_t		isEavesDropping;			/* State in which the WISP executes blockwrite commands, without backscatter        */
