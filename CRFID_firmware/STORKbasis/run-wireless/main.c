...
void main (void) {
	...
	wispData.epcBuf[4] = 0xd2; // Address
	wispData.epcBuf[5] = 0x22; // Address
	wispData.epcBuf[6] = 0x22; // Checksum
	wispData.epcBuf[7] = 0x22;
	wispData.epcBuf[8] = 0x22;
	wispData.epcBuf[9] = 0x22; // RFID Status/Control
	wispData.epcBuf[10]= 0x22; // RFID Status/Control
	wispData.epcBuf[11]= 0x22;
